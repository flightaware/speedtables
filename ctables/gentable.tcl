...
proc compile {fileFragName version} {
	...
	"Darwin" {
	    ...
	    exec gcc -pipe $optflag -fPIC -dynamiclib  -Wall -Wno-implicit-int -fno-common -headerpad_max_install_names -Wl,-search_paths_first -Wl,-single_module -o $buildPath/${fileFragName}${version}.dylib $objFile /sc/lib/pgtcl1.6/libpgtcl1.6.dylib -L/sc/lib -lpq -L/sc/lib $stub
