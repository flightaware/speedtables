...
set expect(jonas_jr) [list id jonas_jr name {Doctor Jonas Venture Junior} home {Spider Skull Island} show {Venture Bros} dad jonas alive 1 gender {} age 45 coolness 120]
...
set expect(brock) [list id brock name {Brock Sampson} home {Venture Compound} show {Venture Bros} dad {} alive 1 gender {} age 35 coolness 100]

set expectKey(3) rick
set expect(rick) [list id rick name {Coroner Rock} home {} show {Stroker and Hoop} dad {} alive 1 gender {} age 51 coolness 99]
...
puts -nonewline "search of t in descending coolness limit 5 / code body..."
set i 0
