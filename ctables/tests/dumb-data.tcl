...
t set rusty name "Rusty Venture" show $show home $home dad jonas age 45 coolness 6
t set jonas_jr name "Doctor Jonas Venture Junior" show $show home "Spider Skull Island" dad jonas age 45 coolness 120

set home "The Cocoon"
t set doctor_girlfriend name "Doctor Girlfriend" show $show home $home gender female age 30 coolness 80
t set the_monarch name "The Monarch" show $show home $home age 40 coolness 36
t set 21 name "Number 21" show $show home $home age 35 coolness 7
t set 28 name "Number 28" show $show home $home age 36 coolness 9
...
t set meatwad name "Meatwad" show $show home $home  age 4 coolness -7
t set shake name "Master Shake" show $show home $home  age 4 coolness -5
t set frylock name "Frylock" show $show home $home age 4 coolness 8
t set carl name "Carl" show $show home "New Jersey" age 43 coolness 5
t set inignot name "Inignot" show $show home "The Moon" age 2 coolness 31
t set ur name "Ur" show $show home "The Moon" age 1 coolness 26
...
t set zorak name "Zorak" show $show age 16 coolness 64
t set mom name "Mom" show $show gender female age 41 coolness 101
t set thundercleese name "Thundercleese" show $show age 6 coolness 16
t set clarence name "Clarence" show $show age 15 coolness -11

set show "Stroker and Hoop"
t set stroker name "John Strokmeyer" show $show age 40 coolness 33
...
t set rick name "Coroner Rock" show $show age 51 coolness 99
